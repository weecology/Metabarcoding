...
dat1 <- prep_2017_allsp_relabund_WTU(samples, reads_genus, totals, OTU_WTU_key, "genus", 2000, 2017, 0.01)
dat2 <- prep_2017_allsp_relabund_WTU(samples, reads_genus, totals, OTU_WTU_key, "genus", 2000, 2017, 0.05)
dat3 <- prep_2017_allsp_relabund_WTU(samples, reads_genus, totals, OTU_WTU_key, "genus", 2000, 2017, 0.005)
dat4 <- prep_2017_allsp_relabund_WTU(samples, reads_genus, totals, OTU_WTU_key, "genus", 2000, 2017, 0.001)

reads_family <- summarize_trnL_by_WeeTU(reads, "WTU.family", WTU.family)
dat5 <- prep_2017_allsp_relabund_WTU(samples, reads_family, totals, OTU_WTU_key, "family", 2000, 2017, 0.01)
dat6 <- prep_2017_allsp_relabund_WTU(samples, reads_family, totals, OTU_WTU_key, "family", 2000, 2017, 0.05)
dat7 <- prep_2017_allsp_relabund_WTU(samples, reads_family, totals, OTU_WTU_key, "family", 2000, 2017, 0.005)
dat8 <- prep_2017_allsp_relabund_WTU(samples, reads_family, totals, OTU_WTU_key, "family", 2000, 2017, 0.001)
